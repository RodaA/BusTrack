...
class StopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post stops_url, params: { stop: { coordinates_LA: @stop.coordinates_LA, coordinates_LO: @stop.coordinates_LO, stopID: @stop.stopID, stopName: @stop.stopName } }
    end
  ...
  test "should update stop" do
    patch stop_url(@stop), params: { stop: { coordinates_LA: @stop.coordinates_LA, coordinates_LO: @stop.coordinates_LO, stopID: @stop.stopID, stopName: @stop.stopName } }
