...
class BusRoutesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus_route" do
    assert_difference('BusRoute.count') do
      post bus_routes_url, params: { bus_route: { busID: @bus_route.busID, routeID: @bus_route.routeID } }
    end
  ...
  test "should update bus_route" do
    patch bus_route_url(@bus_route), params: { bus_route: { busID: @bus_route.busID, routeID: @bus_route.routeID } }
